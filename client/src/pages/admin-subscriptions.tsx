          ...
          <CardContent className="p-0">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-stone-50/50 dark:bg-[#0B0D10]/20 border-b border-stone-100 dark:border-border">
                  <tr>
        ...
        <Dialog open={!!giftTarget} onOpenChange={open => { if (!open) setGiftTarget(null); }}>
          <DialogContent className="max-w-sm rounded-2xl">
            ...
            <div className="space-y-4 pt-2">
              <div className="p-3 bg-stone-50 dark:bg-[#0B0D10]/20 rounded-lg">
