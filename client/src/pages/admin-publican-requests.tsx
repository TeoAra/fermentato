      ...
      <CardContent className="pt-6">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          <div className="flex-1 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <Badge 
                className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                  request.status === 'pending' ? 'bg-stone-50 text-primary dark:bg-[#0B0D10]/20 dark:text-orange-400' : 
            ...
            <div className="flex items-center gap-4 text-xs text-muted-foreground pt-2 border-t border-stone-100 dark:border-border">
            ...
            {request.adminNotes && (
              <div className="bg-stone-50/50 dark:bg-[#0B0D10]/10 p-3 rounded-xl mt-2 border border-stone-100 dark:border-border">
      ...
      <Card className="mb-4 bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl border border-white/40 dark:border-white/[0.06] rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.3)] transition-all duration-200 overflow-hidden">
        <CardContent className="pt-5 pb-4">
          ...
          <div className="flex items-start gap-3 mb-4">
            <div className="w-9 h-9 rounded-xl bg-stone-50 dark:bg-[#0B0D10]/20 flex items-center justify-center shrink-0 mt-0.5 border border-stone-200 dark:border-[#23262E]/50">
          ...
          <div className="space-y-2 text-sm text-muted-foreground ml-12">
            ...
            {request.description && (
              <p className="text-sm text-muted-foreground italic bg-stone-50/30 dark:bg-[#0B0D10]/10 p-2 rounded-lg border border-transparent hover:border-stone-100 transition-colors">{request.description}</p>
            )}

            {request.adminNotes && (
              <div className="bg-stone-50/50 dark:bg-[#0B0D10]/10 p-2.5 rounded-xl border border-stone-100 dark:border-border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 mt-4 pt-3 border-t border-stone-100 dark:border-border">
      ...
      <PageContainer variant="standard" className="py-8">
        ...
        {section === "pub" && (
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsList className="mb-6 bg-stone-50 dark:bg-[#0B0D10]/20 p-1 rounded-xl border border-stone-200 dark:border-[#23262E]/50">
        ...
        <Dialog open={!!dialogTarget} onOpenChange={(open) => !open && setDialogTarget(null)}>
          <DialogContent className="rounded-2xl border-stone-200 dark:border-border">
            <DialogHeader>
            ...
            <DialogFooter className="gap-2">
              <Button variant="outline" onClick={() => setDialogTarget(null)} className="rounded-xl border-stone-200 dark:border-border hover:bg-stone-50">
                Annulla
              </Button>
              <Button
