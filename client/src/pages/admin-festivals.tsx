    ...
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-w-md bg-white dark:bg-card border-stone-100 dark:border-border rounded-2xl">
        ...
        <div className="space-y-4">
          ...
          {selectedUser && (
            <div className="flex items-center gap-3 p-3 bg-stone-50 dark:bg-orange-900/20 border border-stone-200 dark:border-[#23262E] rounded-xl">
    ...
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-w-md bg-white dark:bg-card border-stone-100 dark:border-border rounded-2xl">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-primary bg-stone-50 dark:bg-orange-900/20 border border-stone-200 dark:border-[#23262E] rounded-lg px-3 py-2">
