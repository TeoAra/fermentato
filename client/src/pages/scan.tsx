      ...
      <div className="sticky top-0 z-20 bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl border-b border-white/40 dark:border-white/[0.06] shadow-[0_4px_20px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.3)] transition-all duration-200">
        <div className="flex items-center gap-3 px-4 py-3">
          <button
            ...
            className="p-2 rounded-full hover:bg-stone-100 dark:hover:bg-[#1A1D24] transition-colors text-muted-foreground dark:text-stone-400"
          >
        ...
        <div className="px-4 pb-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-9 py-2.5 bg-stone-100 dark:bg-[#1A1D24] rounded-xl text-sm text-foreground dark:text-white placeholder-gray-400 border-0 focus:outline-none focus:ring-2 focus:ring-amber-400"
            />
            {manualQuery && (
              <button
                  ...
                  {beers.map(beer => {
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-center gap-3 bg-white dark:bg-[#0B0D10] rounded-2xl p-3 shadow-sm border active:scale-[0.98] transition-all cursor-pointer ${
                          isConfirmed
                            ? "border-green-400 dark:border-green-600 ring-1 ring-green-300 dark:ring-green-700"
                            : "border-gray-100 dark:border-[#23262E] hover:border-amber-200 dark:hover:border-amber-900"
                        }`}
                      >
                        ...
                        <button
                          ...
                          className={`shrink-0 flex items-center justify-center w-8 h-8 rounded-full transition-all ${
                            isConfirmed
                              ...
                              : "border-2 border-gray-200 dark:border-[#23262E] text-gray-300 dark:text-gray-600 hover:border-green-400 hover:text-green-400 dark:hover:border-green-500 dark:hover:text-green-500"
                          }`}
                ...
                <div className="space-y-2">
                  {breweries.map(brewery => (
                    <div
                      ...
                      className="flex items-center gap-3 bg-white dark:bg-[#0B0D10] rounded-2xl p-3 shadow-sm border border-gray-100 dark:border-[#23262E] active:scale-[0.98] transition-transform cursor-pointer hover:border-blue-200 dark:hover:border-blue-900"
                    >
          ...
          <div className="mb-4">
            ...
            {manualConfirmedBeer ? (
              ...
              <div className="rounded-2xl p-3 bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl border border-white/40 dark:border-white/[0.06] shadow-[0_4px_20px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.3)] transition-all duration-200">
                ...
                <div className="relative mb-3">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-2 text-sm bg-stone-50 dark:bg-[#1A1D24] border border-gray-200 dark:border-[#23262E] rounded-xl outline-none focus:ring-1 focus:ring-amber-400 dark:focus:ring-amber-600"
                  />
                  {isFallbackSearching && (
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 text-xs font-medium text-muted-foreground dark:text-stone-400 border border-dashed border-gray-200 dark:border-[#23262E] rounded-2xl hover:border-amber-300 hover:text-amber-600 dark:hover:border-amber-700 dark:hover:text-amber-400 transition-colors"
              >
            ...
            <div className="space-y-2">
              {imageSimilarResults.map(beer => (
                <div
                  ...
                  className="flex items-center gap-3 bg-white dark:bg-[#0B0D10] rounded-2xl p-3 shadow-sm border border-purple-100 dark:border-purple-900/40 active:scale-[0.98] transition-transform cursor-pointer hover:border-purple-300 dark:hover:border-purple-700"
                >
                  <div className="w-12 h-12 rounded-xl bg-amber-50 dark:bg-amber-900/20 flex items-center justify-center overflow-hidden shrink-0">
