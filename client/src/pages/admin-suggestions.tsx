...
function DiffRow({ field, current, proposed }: { field: string; current: any; proposed: any }) {
  ...
  return (
    <div className="grid grid-cols-3 gap-3 py-2 border-b border-gray-100 dark:border-[#23262E] last:border-0">
    ...
    <Card className="bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl border border-white/40 dark:border-white/[0.06] rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.3)] transition-all duration-200">
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <Avatar className="h-7 w-7">
              ...
              <AvatarFallback className="text-xs bg-gray-200 dark:bg-[#12151A]">{userInitial}</AvatarFallback>
            </Avatar>
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          {expanded && (
            <div className="mt-3 p-3 bg-gray-50 dark:bg-[#0B0D10] rounded-lg">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-amber-50/20 dark:from-gray-950 dark:to-amber-950/10">
      ...
      <div className="bg-white dark:bg-[#0B0D10] border-b border-gray-200 dark:border-[#23262E] sticky top-0 z-10">
        <PageContainer variant="standard" className="py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="h-4 w-px bg-gray-200 dark:bg-[#12151A]" />
      ...
      <PageContainer variant="standard" className="py-6 space-y-5">
        {/* Status tabs */}
        <div className="flex gap-2 p-1 bg-gray-100 dark:bg-[#1A1D24] rounded-lg w-fit">
          {(["pending", "approved", "rejected"] as const).map((s) => (
            <button
              ...
              className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all ${
                statusFilter === s
                  ? "bg-white dark:bg-[#12151A] shadow-sm text-gray-900 dark:text-white"
        ...
        {isLoading ? (
          <div className="space-y-4">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="h-40 bg-gray-200 dark:bg-[#1A1D24] rounded-xl animate-pulse" />
            ))}
          </div>
