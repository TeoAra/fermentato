...
>(({ className, children, position = "popper", collisionPadding = 12, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "ui-floating-motion relative z-[70] max-h-[min(var(--radix-select-content-available-height),calc(100dvh-2rem))] min-w-[8rem] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 origin-[--radix-select-content-transform-origin]",
        position === "popper" &&
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "max-h-[calc(100dvh-3rem)] overflow-y-auto overscroll-contain p-1",
          position === "popper" &&
