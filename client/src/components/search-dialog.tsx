          ...
          <button
            ...
            className={`text-xs font-medium px-3 py-1 rounded-full border transition-all ${
              filterGlutenFree
                ...
                : "border-stone-200 dark:border-stone-700 text-stone-500 dark:text-stone-400 hover:border-green-300"
            }`}
          >
            Gluten Free
          </button>
          <button
            ...
            className={`text-xs font-medium px-3 py-1 rounded-full border transition-all ${
              filterAlcoholFree
                ...
                : "border-stone-200 dark:border-stone-700 text-stone-500 dark:text-stone-400 hover:border-blue-300"
            }`}
          >
            Analcolica
          </button>
            ...
            <div className="px-4 py-4 space-y-3">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="flex items-center gap-3 animate-pulse">
                  <div className="h-9 w-9 bg-stone-200 dark:bg-stone-700 rounded-lg flex-shrink-0" />
                ...
                return (
                  <div>
                    ...
                    {searchResults.users.map((u: any, i: number) => (
                      ...
                      >
                        <div className="h-9 w-9 rounded-full bg-stone-200 dark:bg-stone-700 flex-shrink-0 overflow-hidden">
                          {u.profileImageUrl
