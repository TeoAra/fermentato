...
export default function BotConnectCard({ pubId }: Props) {
  ...
  return (
    <div className="space-y-4">
            ...
            <>
              <div className="text-sm text-stone-600 dark:text-stone-400 space-y-2">
                ...
                <ol className="space-y-1.5 text-xs text-stone-500 list-decimal list-inside">
                  ...
                  <li>Invia il messaggio: <code className="bg-stone-100 dark:bg-[#1A1D24] px-1 rounded">/start [codice]</code></li>
                </ol>
              </div>
              ...
              {generatedToken ? (
                <div className="space-y-2">
                  ...
                  <div
                    className="flex items-center gap-2 p-3 bg-stone-100 dark:bg-[#1A1D24] rounded-xl cursor-pointer"
                    onClick={copyToken}
                  >
      ...
      {/* Esempio comandi */}
      <div className="p-3 bg-stone-50 dark:bg-[#1A1D24]/40 rounded-2xl border border-stone-100 dark:border-[#23262E]/50">
