...
export default function Footer() {
  return (
    <footer className="bg-[hsl(38,14%,94%)] dark:bg-[#0B0D10] text-[hsl(28,12%,36%)] dark:text-[hsl(35,8%,58%)] border-t border-[hsl(36,14%,87%)] dark:border-[hsl(25,12%,15%)] mt-16 pb-16 lg:pb-0 -mb-16 lg:mb-0">
