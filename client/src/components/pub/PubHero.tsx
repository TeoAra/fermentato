    ...
    >
      ...
      <div className="relative px-4 -mt-10 pb-2">
        <motion.div
          ...
          className="relative bg-white rounded-[24px] border border-[#E8DED1] shadow-[0_8px_30px_rgba(0,0,0,0.06)] px-5 pt-10 pb-5"
        >
          {/* Logo */}
          <div className="absolute -top-8 left-5">
            <div className="w-16 h-16 rounded-full bg-white border-2 border-white shadow-[0_4px_16px_rgba(0,0,0,0.12)] overflow-hidden">
              <ImageWithFallback
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-black text-[#151515] leading-tight" data-testid="pub-hero-name">
              {pub?.name || "Pub"}
            </h1>

            <div className="flex items-center gap-1.5 text-[#6B6357] text-sm">
          ...
          <div className="grid grid-cols-3 gap-2 mt-4">
            <button
              ...
              onClick={onCall}
              disabled={!hasPhone}
              className="flex items-center justify-center gap-1.5 px-3 h-11 rounded-full border border-[#F59E0B] bg-white text-[#F59E0B] font-semibold text-sm active:scale-95 transition-all disabled:opacity-40 disabled:active:scale-100"
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-3 h-11 rounded-full border border-[#F59E0B] bg-white text-[#F59E0B] font-semibold text-sm active:scale-95 transition-all"
