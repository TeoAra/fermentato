        ...
        <div className="flex items-center gap-3 mt-1 px-2">
          ...
          {isAuthenticated && !isMine && (
            <div className="relative">
              ...
              {menuOpen && (
                <div className="absolute left-0 top-full mt-1 z-20 bg-white dark:bg-[#1A1D24] border border-stone-200 dark:border-[#23262E] rounded-lg shadow-lg py-1 min-w-[120px]">
                  <button
  ...
  return (
    <>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-lg rounded-2xl max-h-[85vh] flex flex-col p-0 gap-0">
          <DialogHeader className="px-5 pt-5 pb-3 border-b border-stone-100 dark:border-[#23262E] flex-shrink-0">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setDialogOpen(false)} className="text-stone-400 hover:text-stone-600 transition-colors p-1">
                <X className="w-4 h-4" />
              </button>
            </div>
            {/* Mini like bar */}
          ...
          {/* New comment input */}
          {isAuthenticated && (
            <div className="px-5 py-3 border-t border-stone-100 dark:border-[#23262E] flex-shrink-0">
              <div className="flex gap-2 items-end">
                ...
                <div className="flex-1 flex gap-2 items-end">
                  <Textarea
                    ...
                    placeholder="Scrivi un commento… (Shift+Invio per andare a capo)"
                    rows={1}
                    className="rounded-2xl text-sm min-h-[2.25rem] py-2 resize-none whitespace-pre-wrap flex-1"
                    onKeyDown={e => {
                  ...
                  <button
                    ...
                    className="text-primary disabled:text-stone-300 p-2 flex-shrink-0 hover:bg-primary/10 rounded-full transition-colors"
                  >
