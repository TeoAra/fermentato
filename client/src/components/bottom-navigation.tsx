    ...
    <>
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 safe-area-pb">
        <div className="flex items-center justify-between px-6 py-2">
          ...
          {/* Attività */}
          <Link href="/activity">
            <div className={`relative flex flex-col items-center justify-center py-2 px-3 transition-colors ${
          ...
          {/* Cerca - Centro con design prominente */}
          <button
            onClick={() => setIsSearchOpen(true)}
            className="relative bg-orange-600 hover:bg-orange-700 dark:bg-orange-500 dark:hover:bg-orange-600 text-white rounded-full p-4 shadow-lg transition-all duration-200 transform active:scale-95"
          >
